...
"font: 75 11pt \"Segoe UI\";")
        ...
        self.dial_tidal_volume = QtWidgets.QDial(self.centralwidget)
        self.dial_tidal_volume.setMaximumSize(QtCore.QSize(150, 70))
        self.dial_tidal_volume.setMinimum(250)
        self.dial_tidal_volume.setMaximum(800)
        self.dial_tidal_volume.setObjectName("dial_tidal_volume")
        self.horizontalLayout_2.addWidget(self.dial_tidal_volume)
...
"font: 75 11pt \"Segoe UI\";")
        ...
        self.dial.setMaximumSize(QtCore.QSize(150, 70))
...
"font: 75 11pt \"Segoe UI\";")
        ...
        self.dial_2.setMaximumSize(QtCore.QSize(150, 70))
        self.dial_2.setMinimum(1)
        self.dial_2.setMaximum(3)
...
"font: 75 11pt \"Segoe UI\";")
        ...
        self.dial_3.setMaximumSize(QtCore.QSize(150, 70))
        self.dial_3.setMinimum(10)
        self.dial_3.setMaximum(50)
        self.dial_3.setObjectName("dial_3")
        self.horizontalLayout_5.addWidget(self.dial_3)
...
"font: 75 11pt \"Segoe UI\";")
        ...
        self.dial_4.setMaximumSize(QtCore.QSize(150, 70))
        self.dial_4.setMaximum(10)
        self.dial_4.setObjectName("dial_4")
        self.horizontalLayout_6.addWidget(self.dial_4)
...
"font: 75 11pt \"Segoe UI\";")
        ...
        self.dial_5.setMaximumSize(QtCore.QSize(150, 70))
        self.dial_5.setMaximum(100)
        self.dial_5.setObjectName("dial_5")
        self.horizontalLayout_7.addWidget(self.dial_5)
...
"border-radius: 10px;")
        ...
        self.dial_tidal_volume.valueChanged['int'].connect(self.txt_tidal_volume.setValue)
        self.txt_tidal_volume.valueChanged['int'].connect(self.dial_tidal_volume.setValue)
        self.dial.valueChanged['int'].connect(self.txt_resprate.setValue)
        self.txt_resprate.valueChanged['int'].connect(self.dial.setValue)
        self.txt_ieratio.valueChanged['int'].connect(self.dial_2.setValue)
        self.dial_2.valueChanged['int'].connect(self.txt_ieratio.setValue)
        self.dial_3.valueChanged['int'].connect(self.txt_peakflow.setValue)
        self.txt_peakflow.valueChanged['int'].connect(self.dial_3.setValue)
        self.dial_4.valueChanged['int'].connect(self.txt_peep.setValue)
        self.txt_peep.valueChanged['int'].connect(self.dial_4.setValue)
        self.dial_5.valueChanged['int'].connect(self.txt_fio2.setValue)
        self.txt_fio2.valueChanged['int'].connect(self.dial_5.setValue)
